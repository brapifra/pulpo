  ...
  async function fetchData() {
    try {
      ...
      while(finalData.viewer.pullRequests.pageInfo.hasNextPage) {
        const { data: fetchMoreResult, errors: fetchMoreErrors } = await client.query({
          query,
          variables: {
        ...
        finalData = {
          ...
          viewer: {
            ...
            pullRequests: {
              ...
              edges: [...finalData.viewer.pullRequests.edges, ...fetchMoreResult.viewer.pullRequests.edges]
            }
          }
        }
      }
